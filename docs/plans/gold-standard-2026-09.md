...
> **Superseded 2026-09-07 — do not implement from this document.** The operator chose Concept A on 2026-09-06, and this plan was replaced by [visual-overhaul-a-2026-09.md](visual-overhaul-a-2026-09.md), which kept this plan's discipline and re-scoped its slices to Concept A. That plan is complete: all thirteen slices landed by 2026-09-09. Nothing here was ever implemented under a `Gold S<N>` commit — the commits are `A S<N>`. Kept as the record of the pass that produced the brief, the review and the mocks.
