...
- [Issue #77: Repository professionalization audit remediation](https://github.com/Fikarn/sse-exed-studio-control/issues/77) tracks the May 16, 2026 repository-readiness audit follow-up. Immediate remediation is complete for the stale dependency PR queue, Dependabot alert triage, merged-branch cleanup, current Tauri README screenshots, and historical-design-doc status banners. Remaining items are external GitHub/account blockers and future code-quality ratchets.
