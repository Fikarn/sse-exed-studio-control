...
- the selected shell stack is `Tauri 2 + React 19.2 + TypeScript + Vite`; Qt fallback retirement is governed by Checkpoint D issue #5 and `docs/QT_FALLBACK_RETIREMENT_AUDIT.md`
...
- [Issue #5: Checkpoint D: plan Qt fallback retirement](https://github.com/Fikarn/sse-exed-studio-control/issues/5)
- [docs/QT_FALLBACK_RETIREMENT_AUDIT.md](./QT_FALLBACK_RETIREMENT_AUDIT.md): checked-in Checkpoint D impact audit and proposed removal sequence
