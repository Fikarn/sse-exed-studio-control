...
Authoritative prototype: `/Users/EdvinLandvik/Desktop/2/desk-v10.html`
...
- `git status --short`:
  ...
  ?? test-results/
  ```
- Prototype line count: `16228 /Users/EdvinLandvik/Desktop/2/desk-v10.html`
- Browser policy: raw `file://` Browser access was blocked in the prior audit; use a read-only localhost preview for prototype inspection if needed.
...
| --- | -------------------------------------------------- | -------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------ | --------------------------------------------------------- |
| T0  | Record baseline and confirm prototype source       | verified | `docs/audio-prototype-parity-progress.md`                                                                                                                                                                                                                                                                                                                                                                                                         | `git branch --show-current`, `git status --short`, `wc -l /Users/EdvinLandvik/Desktop/2/desk-v10.html` -> exit 0; recorded branch/status/prototype line count/browser policy                                                                                                                                                                                                                                                                                                                                                                                                                                       | none                                                      |
...
- Do not use any audio prototype except `/Users/EdvinLandvik/Desktop/2/desk-v10.html`.
