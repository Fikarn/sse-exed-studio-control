...
// Runs only as `node scripts/check-slice-rescope.mjs <files>`: an import does
// nothing (2026-09-26; the run reads git diff --cached and ends the process
// with the check's result). The two paths are compared as real paths — through
