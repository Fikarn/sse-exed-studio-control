...
// Runs only as `node scripts/release/validate-release.mjs`: an import does
// nothing (2026-09-26; the run ends the process with the check's result). The
// two paths are compared as real paths — through a directory junction or a
// short 8.3 name, `process.argv[1]` and `import.meta.url` spell the same file
