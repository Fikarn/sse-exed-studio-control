...
// Runs only as `node scripts/native-packaged-acceptance.mjs …`: an import does
// nothing (2026-09-26; the run starts the packaged app from release/native and
// ends the process when it fails). The two paths are compared as real paths —
