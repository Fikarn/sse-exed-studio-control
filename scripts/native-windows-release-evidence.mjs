...
// Runs only as `node scripts/native-windows-release-evidence.mjs …`: an import
// does nothing (2026-09-26; the run starts npm run native:release:win:local,
// which rebuilds release/, and writes an evidence folder). The two paths are
