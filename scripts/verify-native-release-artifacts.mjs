...
// Runs only as `node scripts/verify-native-release-artifacts.mjs …`: an import
// does nothing (2026-09-26; the run reads and hashes the release artifacts
// under release/ and fails the process when one is missing). The two paths are
