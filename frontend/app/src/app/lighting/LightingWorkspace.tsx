...
import type { LightingDmxMonitorSnapshot, LightingSnapshot, ShellStore } from "@sse/engine-client";
...
import {
  LIGHTING_NUDGE_METERS,
  LIGHTING_ROOM_WIDTH_METERS,
  buildLightingSections,
  clampLightingIntensity,
  fallbackFixturePosition,
  fixtureMatchesLightingSection,
  formatDmxValue,
  formatLightingBeamAngleValue,
  formatLightingCueFadeSeconds,
  formatLightingRigHeight,
  formatLightingValueRange,
  interpolateLightingValue,
  isLightingRangeCommitKey,
  lightingCueTone,
  lightingFixtureBeamAngle,
  lightingFixtureBeamLength,
  lightingFixtureBeamOpacity,
  lightingFixtureBeamWidth,
  lightingFixtureCctPercent,
  lightingFixtureCctRange,
  lightingFixtureColor,
  lightingFixtureStageFadeOpacity,
  lightingSearchMatchesFixture,
  lightingStatusTone,
} from "./lightingHelpers";
import {
  buildLightingPatchCandidates,
  buildLightingPatchOverlapMap,
  findNextLightingFixtureStartAddress,
  formatLightingPatchOverlapStageLabel,
