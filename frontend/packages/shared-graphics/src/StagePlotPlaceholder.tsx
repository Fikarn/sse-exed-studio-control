...
export function StagePlotPlaceholder({ title, subtitle }: StagePlotPlaceholderProps) {
  return (
    <svg viewBox="0 0 720 420" role="img" aria-label={title} style={{ width: "100%", height: "100%" }}>
      ...
      <text x="92" y="92" fill="#F4F8F2" fontFamily="IBM Plex Sans, sans-serif" fontSize="24" fontWeight="600">
        {title}
      </text>
      <text x="92" y="122" fill="#B7C2BA" fontFamily="IBM Plex Sans, sans-serif" fontSize="14">
        {subtitle}
      </text>
    </svg>
  );
